...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-xxl d-flex flex-column flex-md-row flex-stack">
        ...
        <div class="text-dark order-2 order-md-1">
            <span class="text-gray-400 fw-bold me-1">{{env('APP_NAME')}} &copy;</span>
            <a href="#" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">Impetus</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
...
<div id="kt_drawer_chat" class="bg-body drawer drawer-end drawer-on" data-kt-drawer="true" data-kt-drawer-name="chat" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_drawer_chat_toggle" data-kt-drawer-close="#kt_drawer_chat_close" style="width: 500px !important;">
    ...
    <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="symbol symbol-35px symbol-circle">
                                <img alt="Pic" src="/metronic8/demo4/assets/media/avatars/300-25.jpg">
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Details-->
                            <div class="ms-3">
                ...
                <div class="d-flex justify-content-end mb-10">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Avatar-->
                            <div class="symbol symbol-35px symbol-circle">
                                <img alt="Pic" src="/metronic8/demo4/assets/media/avatars/300-1.jpg">
                            </div>
                            <!--end::Avatar-->
                        </div>
                        <!--end::User-->
        ...
        <!--end::Card body-->
        <!--begin::Card footer-->
        <div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer" data-dashlane-rid="965e5b3087def02a" data-form-type="">
            <!--begin::Input-->
            <textarea class="form-control form-control-flush mb-3" rows="1" data-kt-element="input" placeholder="Type a message" data-dashlane-rid="d7b1b4521ce24df0" data-form-type=""></textarea>
            <!--end::Input-->
            <!--begin:Toolbar-->
            <div class="d-flex flex-stack">
                <!--begin::Actions-->
                <div class="d-flex align-items-center me-2">
                    <button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="" data-bs-original-title="Coming soon" data-dashlane-rid="c9279a426379ca7a" data-dashlane-label="true" data-form-type="">
                        <i class="bi bi-paperclip fs-3"></i>
                    </button>
                    <button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="" data-bs-original-title="Coming soon" data-dashlane-rid="8b7b1841fc45a974" data-dashlane-label="true" data-form-type="">
                        <i class="bi bi-upload fs-3"></i>
                    </button>
                </div>
                <!--end::Actions-->
                <!--begin::Send-->
                <button class="btn btn-primary" type="button" data-kt-element="send" data-dashlane-rid="0c20657baa8da6ef" data-dashlane-label="true" data-form-type="">Send</button>
                <!--end::Send-->
            </div>
            <!--end::Toolbar-->
        </div>
