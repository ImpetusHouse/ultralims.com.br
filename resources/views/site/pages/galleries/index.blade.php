...
@endpush
@section('content')
    <section class="relative py-12 sm:py-24 overflow-hidden" style="background-color: white">
        ...
        $('.load-more').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('.galleries-container').append(response);
                    generateLightBox();

                    // Verifica se há menos de 6 publicações na resposta
                    var numPublicacoes = $(response).filter('.gallery-container').length;
