...
@section('content')
    <section class="py-12 bg-gray-50">
        <div class="container px-4 mx-auto">
            <h1 class="font-heading text-coolGray-800 text-3xl font-semibold mb-6">Cart</h1>
            <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="flex w-full">
                            <div class="w-96">
                                <div class="w-full py-4 px-6 border-b border-coolGray-200">
                                    <span class="text-rhino-800">Product</span>
                                </div>
                            ...
                            <div class="w-40">
                                <div class="py-4 px-6 border-b border-coolGray-200">
                                    <span class="text-rhino-800">Price</span>
                                </div>
                            ...
                            <div class="w-40">
                                <div class="py-4 px-6 border-b border-coolGray-200">
                                    <span class="text-rhino-800">Quantity</span>
                                </div>
                                <div class="py-4 px-6 border-b border-coolGray-200 h-32 flex items-center">
                ...
                <div class="w-full lg:w-1/3 px-4">
                    <div class="bg-white rounded-xl shadow-md p-6">
                        <h2 class="text-rhino-700 text-lg mb-4 font-semibold">Cart totals</h2>
                        ...
                        <a class="bg-purple-500 py-3 px-4 rounded-sm text-white text-center hover:bg-purple-600 transition duration-200 w-full inline-block" href="#">Go to Checkout</a>
                    </div>
                </div>
            </div>
        </div>
