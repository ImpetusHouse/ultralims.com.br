<footer class="pt-12 overflow-hidden" style="background-color: #0E1326">
        ...
        <div class="pb-6 border-b border-gray-800">
            <div class="flex flex-wrap -m-8">
                <div class="w-full sm:w-1/2 lg:w-6/12 p-8">
                    <div class="lg:max-w-sm">
                        <a class="mb-8 inline-block" href="/">
                            <img src="{{ asset('images/logos/'.env('APP_NAME').'.png') }}" alt="">
                        </a>
                        <p class="mb-10 text-gray-400 font-medium leading-relaxed md:max-w-xs">A Ultra LIMS foi criada para inovar na gestão laboratorial, oferecendo uma tecnologia acessível e eficaz.</p>
                        <div class="flex flex-wrap -m-1.5">
                            <div class="w-auto p-1">
                                <a href="https://www.facebook.com/ultralims" target="_blank">
                ...
                <div class="w-full sm:w-1/2 lg:w-3/12 p-8">
                    <h3 class="mb-8 text-sm text-gray-600 uppercase font-semibold leading-normal tracking-px">Empresa</h3>
                    <ul>
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/ouvidoria/">
                                Ouvidoria
                            </a>
                        </li>
                        <li class="mb-5">
                        ...
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/carreiras">
                                Carreira
                            </a>
                        </li>
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/fale-conosco">
                                Fale conosco
                            </a>
                        </li>
                        <li>
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/admin">
                                Extranet
                            </a>
                        </li>
                    </ul>
                ...
                <div class="w-full sm:w-1/2 lg:w-3/12 p-8">
                    <h3 class="mb-8 text-sm text-gray-600 uppercase font-semibold leading-normal tracking-px">Termos Legais</h3>
                    <ul>
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/pdf/Manual_de_Conduta.pdf" target="_blank">
                                Código de Ética e Conduta
                            </a>
                        </li>
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/pdf/PS001_-_Politica_de_Privacidade_App.pdf" target="_blank">
                                Política de Privacidade
                            </a>
                        </li>
                        <li class="mb-5">
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/pdf/documento_396_Visual.pdf" target="_blank">
                                Política da Qualidade
                            </a>
                        </li>
                        <li>
                            <a class="text-white hover:opacity-70 font-medium leading-relaxed" href="https://ultralims.com.br/pdf/Politica_LGPD_-_Ultralims.pdf" target="_blank">
            ...
            <div class="w-full flex justify-end">
                <img src="{{ asset('images/logos/iso-9001.png') }}" style="height: 100px">
            </div>
        </div>
        <p class="py-5 text-sm text-gray-300 font-medium text-center leading-normal flex justify-between">
            <span>Todos os direitos reservados © 2024 - {{ env('APP_NAME') }}</span>
