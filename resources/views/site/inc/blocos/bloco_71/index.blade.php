        ...
        <div class="mx-auto">
            ...
            <form id="form-{{ $block->id }}" class="flex flex-wrap -m-3" action="{{ route('saveContato') }}">
                ...
                <div class="w-full md:w-1/2 p-3">
                    <label class="block">
                        <input type="text" placeholder="Empresa" name="company_name" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                    </label>
                </div>
                <div class="w-full md:w-1/2 p-3">
                    <label class="block">
                        <input required type="text" placeholder="CPF/CNPJ" name="cpf_cnpj" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200 mask-cpf-cnpj">
                    </label>
                </div>
                <div class="w-full md:w-1/2 p-3">
                    <label class="block">
                ...
                <div class="w-full md:w-1/2 p-3">
                    <label class="block">
                        <select required name="state" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                ...
                <div class="w-full md:w-1/2 p-3">
                    <label class="block">
                        <input type="text" placeholder="Cidade" name="city" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                    </label>
                </div>
