...
<section id="section_{{ $i }}" class="overflow-hidden" style="background-color: {{ $block->background_color }}; padding-top: {{ $block->margin_top }}px; padding-bottom: {{ $block->margin_bottom }}px;">
    <div class="container px-4 mx-auto">
        <div class="md:max-w-5xl mx-auto mb-8 {{ $block->content_alignment == 'center' ? 'text-center':'' }}">
            <h3 class="mb-4 font-black font-heading">
            ...
            <p class="block-description-{{ $block->id }} mb-10" style="color: {!! $block->content_color !!} !important;">{!! $block->content !!}</p>
            <div class="relative md:w-80 {{ $block->content_alignment == 'center' ? 'mx-auto':'' }}">
