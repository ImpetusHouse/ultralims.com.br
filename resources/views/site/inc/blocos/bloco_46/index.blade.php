                        ...
                        <div class="swiper-slide">
                            <div class="max-w-6xl p-4 flex flex-wrap justify-center items-center">
                                <div class="mb-6 w-full lg:w-1/3 text-center">
                                    <img class="mb-6 mx-auto w-32 h-32 rounded-full object-cover" src="{{ asset(str_replace('public/', 'storage/', $testimonial->path)) }}?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1055&amp;q=80" alt="">
                                    <h4 class="text-xl" style="color: {{ $block->title_color }}">{{ $testimonial->client }}</h4>
                                    <p style="color: {{ $block->subtitle_color }}">{{ $testimonial->description_client }}</p>
                                </div>
                                <div class="w-full lg:w-2/3">
                                    <svg class="mb-4 h-10" viewbox="0 0 32 28" fill="none" xmlns="http://www.w3.org/2000/svg" style="color: {{ $block->primary_color }}">
                                    ...
                                    <h3 class="mb-6 text-3xl lg:text-4xl font-bold font-heading w-full three-line-text" style="color: {{ $block->content_color }}">
