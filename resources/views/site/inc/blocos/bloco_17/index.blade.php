...
@endpush
<section id="section_{{ $i }}" class="py-24 lg:py-28 overflow-hidden form-cta" style="background-color: {{ $block->background_color }}">
            ...
            <form id="form-{{ $block->id }}" class="flex flex-wrap -m-3" action="{{ route('saveContato') }}">
                ...
                @if($block->type == '1')
                    ...
                    <div class="w-full p-3">
                        <label class="block">
                            <input required type="text" placeholder="Nome da empresa" name="company_name" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                        </label>
                    </div>
                @else
                    <div class="w-full p-3">
                    ...
                    <div class="w-full p-3">
                        <label class="block">
                            <input required type="text" placeholder="Cargo" name="office" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                        </label>
                    </div>
                    <div class="w-full md:w-1/2 p-3">
                        <label class="block">
                    ...
                    <div class="w-full md:w-1/2 p-3">
                        <label class="block">
                            <select required name="quantity" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200">
                    ...
                    <div class="w-full p-3">
                        <label class="block">
                            <textarea required placeholder="Qual a sua principal necessidade?" name="message" class="px-4 py-4 w-full text-gray-600 tracking-tight bg-transparent placeholder-gray-600 outline-none border border-gray-600 rounded-lg focus:border-gray-400 transition duration-200 resize-none"></textarea>
                        </label>
                    </div>
                @endif
                <div class="w-full p-3">
                    <button id="btn-{{ $block->id }}" type="submit" class="inline-block mb-4 px-5 py-4 w-full text-center font-semibold tracking-tight rounded-lg hover:opacity-70 focus:ring-4 focus:ring-opacity-70 transition duration-200" style="background-color: {{ $block->button_color }}; color: {{ $block->button_title_color }}">
