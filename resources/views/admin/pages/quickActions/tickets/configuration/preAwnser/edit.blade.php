...
@section('content')
    <form id="customForm" method="POST"
          action="{{route('admin.tickets.configuration.pre-awnser.update', $awnser->hash_id)}}">
        <div class="card card-flush pt-3 mb-5 mb-lg-10">

            <div class="card-header">
                <!--begin::Card title-->
                <div class="card-title">
                    <h2 class="fw-bolder">Editar resposta</h2>
                </div>
                <!--begin::Card title-->
            </div>
            <!--end::Card header-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control" value="{{$awnser->title}}" placeholder="Título" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="awnser" id="content" class="form-control form-control-solid" cols="30" rows="10" style="resize: none">{!!$awnser->awnser!!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
