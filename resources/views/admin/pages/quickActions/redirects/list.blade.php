        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Procurar redirecionamento"/>
                </div>
                <!--end::Search-->
            </div>
            <!--end::Card title-->
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add product-->
                <a href="{{ route('admin.redirects.create') }}" class="btn btn-primary">Adicionar redirecionamento</a>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                ...
                @foreach($redirects as $redirect)
                    <tr>
                        ...
                        <td>
                            {{$redirect->from}}
                            <a class="d-none" data-kt-ecommerce-product-filter="id">{{ $redirect->hash_id }}</a>
                        </td>
                        <td>{{ $redirect->to }}</td>
                        @php
                            $status = '';
                            $badge = '';
                            /** @var TYPE_NAME $redirect */
                            if ($redirect->status == '1'){
                                $status = 'Publicado';
                                $badge = 'success';
                            }elseif ($redirect->status == '0'){
                                $status = 'Inativo';
                                $badge = 'danger';
                            }
                        @endphp
                        ...
                        <td class="text-center">
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.redirects.edit', $redirect->hash_id)}}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
            ...
            var t, e, n = () => {
                t.querySelectorAll('[data-kt-ecommerce-product-filter="delete_row"]').forEach((t => {
                    t.addEventListener("click", (function (t) {
                        ...
                        Swal.fire({
                            text: "Tem certeza que deseja excluir o redirecionamento?",
                            icon: "question",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            if(t.value){
                                $.ajax({
                                    method: "DELETE",
                                    url: `{{route('admin.redirects.destroy', '_id_')}}`.replace('_id_', n.querySelector('[data-kt-ecommerce-product-filter="id"]').innerText),
