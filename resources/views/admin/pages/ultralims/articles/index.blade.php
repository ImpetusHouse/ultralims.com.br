    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add product-->
                <a href="{{ route('admin.ultralims.articles.create') }}" class="btn btn-primary">Adicionar publicação</a>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
        </div>
                ...
                @foreach($articles as $article)
                    <tr>
                        ...
                        <td>
                            <span>
                                <!--begin::Title-->
                                <a href="{{ route('admin.ultralims.articles.edit', $article->hash_id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="name" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ $article->title }}">{{ Str::limit($article->title, 45, '...') }}</a>
                        ...
                        <td class="text-center">
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('admin.ultralims.articles.edit', $article->hash_id) }}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                    ...
                    t.addEventListener("click", (function (t) {
                        ...
                        Swal.fire({
                            ...
                            if(t.value) {
                                $.ajax({
                                    method: "DELETE",
                                    url: `{{route('admin.ultralims.articles.destroy', '_id_')}}`.replace('_id_', n.querySelector('[data-kt-ecommerce-product-filter="id"]').innerText),
