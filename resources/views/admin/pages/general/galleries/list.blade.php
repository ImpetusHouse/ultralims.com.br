        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Procurar galerias"/>
                </div>
                <!--end::Search-->
            </div>
            <!--end::Card title-->
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add product-->
                <a href="{{ route('admin.galleries.create') }}" class="btn btn-primary">Adicionar galeria</a>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="{{ route('admin.galleries.edit', $gallery->hash_id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="name">
                                        {{$gallery->title}}
                                    </a>
                                    <a class="d-none" data-kt-ecommerce-product-filter="id">{{ $gallery->hash_id }}</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.galleries.edit', $gallery->hash_id)}}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
            ...
            var t, e, n = () => {
                t.querySelectorAll('[data-kt-ecommerce-product-filter="delete_row"]').forEach((t => {
                    t.addEventListener("click", (function (t) {
                        ...
                        Swal.fire({
                            text: "Tem certeza que deseja excluir a galeria de fotos?",
                            icon: "question",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            if(t.value){
                                $.ajax({
                                    method: "DELETE",
                                    url: `{{route('admin.galleries.destroy', '_id_')}}`.replace('_id_', n.querySelector('[data-kt-ecommerce-product-filter="id"]').innerText),
                                    success: function (rtn) {
                                        if (rtn.success === true) {
                                            Swal.fire({
                                                text: "Você excluiu a galeria de fotos",
                                                icon: "success",
                                                buttonsStyling: !1,
